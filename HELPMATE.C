...
getfileattb()
{
	...
	if ( oo.x.cflag == 0 )
	{
		...
		writestring ( "ФФФФФФФФФФ", 10, 27, 112 ) ;
		a = oo.x.cx ;
		writeattr ( a, 24 ) ;
	}
	else
	...
	if ( done == 0 )
	{
		...
		while ( done == 0 )
		{
			...
			if ( row == 18 )
			{
				...
				menubox ( 5, 5, 20, 70, 112, 66 ) ;
				writestring ( "Directory listing", 6, 28, 112 ) ;
				writestring ( "ФФФФФФФФФФФФФФФФФ", 7, 28, 112 ) ;
			}
		}
	}
	else
...
logo()
{
	...
	writestring ( "     Yashavant Kanetkar       ", 15, 26, 112 ) ;
	writestring ( "             At               ", 16, 26, 112 ) ;
	writestring ( "    ICIT, 44-A, Gokulpeth     ", 17, 26, 112 ) ;
	writestring ( "     Nagpur-440010, India     ", 18, 26, 112 ) ;
	writestring ( "      Ph. 531046, 535809      ", 19, 26, 112 ) ;
	writestring ( "       Press any key...       ", 22, 26, 112 ) ;

	writestring ( "                                                                       ", 3, 5, 77 ) ;
	writestring ( " лл   лл  лллллл  лл      лллллл  ллм   млл  ллллллл  лллллллл  лллллл ", 4, 5, 77 ) ;
	writestring ( " лл   лл  лл      лл      лл  лл  лл л л лл  лл   лл     лл     лл     ", 5, 5, 77 ) ;
	writestring ( " лл   лл  лл      лл      лл  лл  лл омн лл  лл   лл     лл     лл     ", 6, 5, 77 ) ;
	writestring ( " ллллллл  ллллл   лл      лллллл  лл  л  лл  ллллллл     лл     ллллл  ", 7, 5, 77 ) ;
	writestring ( " лл   лл  лл      лл      лл      лл  п  лл  лл   лл     лл     лл     ", 8, 5, 77 ) ;
	writestring ( " лл   лл  лл      лл      лл      лл     лл  лл   лл     лл     лл     ", 9, 5, 77 ) ;
	writestring ( " лл   лл  лллллл  лллллл  лл      лл     лл  лл   лл     лл     лллллл ", 10, 5, 77 ) ;
	writestring ( "                                                                       ", 11, 5, 77 ) ;
	getch() ;
}
